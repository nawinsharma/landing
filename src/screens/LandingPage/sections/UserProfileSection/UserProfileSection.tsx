  ...
  return (
    <section className="flex flex-col w-full items-center gap-40 py-20">
        ...
        <div className="flex flex-col w-full items-center gap-14">
          ...
          <div className="flex flex-col items-start gap-20 w-full">
            {steps.map((step, index) => (
              <div
                key={`step-${index}`}
                className="w-full flex items-center gap-[78px]"
              >
                {index % 2 !== 0 && (
                  <div
                    className="w-[600px] h-[600px] rounded-[20px] overflow-hidden"
                    style={{ background: step.bgGradient }}
                  >
                    <div className="relative w-[520px] h-[520px] mt-10 ml-10">
                      {index === 1 && (
                        <div className="absolute w-[520px] h-[519px] bg-white rounded-[20px] overflow-hidden shadow-[0px_4px_150px_#d5dae8]">
                          <div className="w-[369px] h-[35px] absolute top-[78px] left-[114px] bg-white rounded-[10px] shadow-[0px_4px_150px_#dde3f1]" />
                          <div className="absolute w-[369px] h-[35px] top-[38px] left-[114px] bg-white rounded-[10px] shadow-[0px_4px_150px_#dde3f1]" />
                          <div className="absolute w-[47px] h-[441px] top-[38px] left-10 bg-white rounded-[10px] shadow-[0px_4px_150px_#dde3f1]" />
                          <div className="absolute w-[361px] h-[332px] top-[147px] left-[122px] shadow-[0px_4px_150px_#dde3f1] bg-white rounded-[20px] overflow-hidden">
                            <div className="w-[311px] top-[122px] left-6 absolute h-[61px] bg-white rounded-[10px] shadow-[0px_4px_150px_#dde3f1]" />
                            <div className="absolute w-[100px] h-[27px] top-[25px] left-6 bg-white rounded-[10px] shadow-[0px_4px_150px_#dde3f1]" />
                            <div className="absolute w-[100px] h-[27px] top-16 left-6 bg-white rounded-[10px] shadow-[0px_4px_150px_#dde3f1]" />
                            <div className="absolute w-[99px] h-[27px] top-[25px] left-[130px] bg-white rounded-[10px] shadow-[0px_4px_150px_#dde3f1]" />
                            <div className="absolute w-[99px] h-[27px] top-16 left-[130px] bg-white rounded-[10px] shadow-[0px_4px_150px_#dde3f1]" />
                            <div className="absolute w-[100px] h-[27px] top-[25px] left-[235px] bg-white rounded-[10px] shadow-[0px_4px_150px_#dde3f1]" />
                            <div className="absolute w-[100px] h-[27px] top-16 left-[235px] bg-white rounded-[10px] shadow-[0px_4px_150px_#dde3f1]" />
                            <div className="w-[311px] h-[61px] top-[195px] left-6 absolute bg-white rounded-[10px] shadow-[0px_4px_150px_#dde3f1]" />
                            <div className="absolute w-[311px] h-[61px] top-[268px] left-6 bg-white rounded-[10px] shadow-[0px_4px_150px_#dde3f1]" />
                          </div>
                        </div>
                      )}
                      {(index === 0 || index === 2 || index === 3) && (
                        <>
                          ...
                          <div className="w-[271px] top-6 left-[225px] absolute h-[61px] bg-white rounded-[10px] shadow-[0px_4px_150px_#dde3f1]" />
                          <div className="w-[271px] h-[61px] top-[95px] left-[225px] absolute bg-white rounded-[10px] shadow-[0px_4px_150px_#dde3f1]" />
                        </>
                      )}
                    </div>
                  </div>
                ...
                <div className="flex flex-col gap-[26px] w-[622px]">
                  <div className="flex flex-col gap-[18px]">
                    <Badge
                      className={`h-[31px] ${step.badgeColor} rounded-[56px] px-3.5 py-1.5`}
                    >
                    ...
                    <h3 className="[font-family:'Alata',Helvetica] font-normal text-[40px] text-[#010512] leading-[50px]">
                      {step.title}
                    </h3>

                    <p className="[font-family:'Rethink_Sans',Helvetica] font-normal text-lg text-[#525358] leading-[27.2px] max-w-[629px]">
                      {step.description}
                    </p>
                  </div>
                  ...
                  <div className="flex flex-col gap-[42px]">
                    <div className="space-y-[37px]">
                      {step.features.map((feature, featureIndex) => (
                        ...
                        >
                          ...
                          />
                          <span className="[font-family:'Rethink_Sans',Helvetica] font-normal text-lg text-[#525358] leading-[27.2px]">
                            {feature}
                          </span>
                        </div>
                      ))}
                    ...
                    <Button
                      className={`rounded-[100px] px-[25px] py-4 h-[50px] ${
                ...
                {index % 2 === 0 && (
                  ...
                  >
                    <div className="relative w-[520px] h-[520px] mt-10 ml-10">
                      {index === 3 && (
                        <div className="absolute w-[520px] h-[519px] bg-white rounded-[20px] overflow-hidden shadow-[0px_4px_150px_#d5dae8]">
                          <div className="w-[369px] h-[35px] top-[78px] left-[114px] absolute bg-white rounded-[10px] shadow-[0px_4px_150px_#dde3f1]" />
                          <div className="absolute w-[369px] h-[35px] top-[38px] left-[114px] bg-white rounded-[10px] shadow-[0px_4px_150px_#dde3f1]" />
                          <div className="absolute w-[47px] h-[441px] top-[38px] left-10 bg-white rounded-[10px] shadow-[0px_4px_150px_#dde3f1]" />
                          <div className="absolute w-[361px] h-[332px] top-[147px] left-[122px] shadow-[0px_4px_150px_#dde3f1] bg-white rounded-[20px] overflow-hidden">
                            <div className="w-[311px] top-[122px] left-6 absolute h-[61px] bg-white rounded-[10px] shadow-[0px_4px_150px_#dde3f1]" />
      ...
      <div className="flex flex-col w-full max-w-[1352px] items-center gap-8">
        <div className="flex flex-col items-center gap-6">
          <div className="flex flex-col w-[854px] items-center gap-2">
            <h2 className="w-[740px] [font-family:'Alata',Helvetica] font-normal text-[#0c0c0c] text-[40px] text-center leading-normal">
              Flexible Pricing, Unbeatable Value
            </h2>

            <p className="w-full h-[67px] [font-family:'Rethink_Sans',Helvetica] font-medium text-[#666666] text-lg text-center leading-normal">
        ...
        <div className="flex flex-col items-center gap-16 w-full">
          ...
          <div className="flex items-center gap-4 w-full">
            {pricingPlans.map((plan, index) => (
              <Card
                key={`plan-${index}`}
                className={`w-[440px] h-[648px] rounded-[20px] border border-solid border-[#e6e9ee] ${plan.highlighted ? "bg-neutral-100 relative" : ""}`}
              >
                <CardContent className="p-0">
                  {plan.highlighted && (
                    <div className="absolute w-[276px] h-[33px] top-0 left-[82px] bg-[#6666ff] rounded-[100px]">
                      <div className="absolute w-[258px] h-[21px] top-1 left-3 font-content text-white">
                        {plan.discount}
                      </div>
                    </div>
                  )}
                  ...
                  <div className="flex w-full items-center justify-between p-[30px]">
                    <div
                      className="w-[50px] h-[50px] bg-cover bg-[50%_50%]"
                    ...
                    <div className="flex items-end">
                      ...
                      <div className="font-content text-[#666666]">
                        {plan.period}
                      </div>
                    </div>
                  </div>
                  ...
                  <p className="mx-[30px] mt-[10px] font-content-2 text-[#666666]">
                    {plan.description}
                  </p>

                  <Separator className="mx-[30px] my-6 border-t border-dashed border-[#e6e9ee]" />

                  <Button
                    className={`mx-[30px] w-[380px] h-[52px] rounded-[10px] ${
                      index === 1
                  ...
                  <div className="mx-[30px] mt-6 font-title-3 text-neutral-800">
                    Features Included:
                  </div>
                  ...
                  <div className="mt-4">
                    {plan.features.map((feature, featureIndex) => (
                      <React.Fragment key={`feature-${featureIndex}`}>
                        <div className="flex items-center mx-[30px] py-2">
                          <div
                          ...
                          <div className="ml-[30px] font-content-2 text-[#333333]">
                            {feature.name}
                          </div>
                          <div
                        ...
                        {featureIndex < plan.features.length - 1 && (
                          <Separator className="mx-[30px] h-px bg-[#e6e9ee]" />
                        )}
                      </React.Fragment>
                    ))}
                  </div>
      ...
      <div className="w-full h-[994px] relative">
        <div className="w-full h-[994px] relative">
          <div className="absolute w-full h-[994px] top-0 left-0 overflow-hidden bg-gradient-to-b from-white to-[rgba(250,250,250,1)]">
            <div className="relative w-full max-w-[2032px] h-[926px] mx-auto mt-[27px]">
              <div className="absolute w-full h-[757px] top-[169px] left-0">
                        ...
                        <CardContent className="p-8">
                          ...
                          <div className="flex items-center gap-4 mt-[82px]">
                            ...
                            <div className="flex flex-col gap-0.5">
                              <div className="[font-family:'SF_Pro-Medium',Helvetica] font-medium text-[#04070d] text-lg leading-[26px]">
                                {testimonial.author}
                              </div>
                              <div className="[font-family:'SF_Pro-Medium',Helvetica] font-medium text-[#04070d] text-base leading-[26px]">
                                {testimonial.role}
                              </div>
                            </div>
                          </div>
              ...
              <div className="flex flex-col items-center gap-2 absolute top-0 left-1/2 transform -translate-x-1/2">
                <h2 className="w-[753px] [font-family:'Alata',Helvetica] font-normal text-[#010512] text-[52px] text-center tracking-[-1.04px] leading-[76px]">
                  What Yogasana lovers say using our Software
                </h2>
                <p className="w-[861px] [font-family:'Rethink_Sans',Helvetica] font-normal text-[#525459] text-lg text-center tracking-[-0.36px] leading-[26px]">
          ...
          <img
            className="absolute w-[368px] h-[30px] top-[92px] left-1/2 transform -translate-x-1/2"
            alt="Vector"
            src="/vector-5-2.svg"
          />
        </div>
